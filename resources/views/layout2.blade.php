        ...
        <div class="navbar-area">
            ...
            <div class="mobile-nav">
                <a href=" {{route('accueil')}} " class="logo">
                    <img src=" {{asset('assets/img/logo2.png')}} "  alt="Logo OctetLab">
                </a>
            </div>
                ...
                <div class="container">
                    <nav class="navbar navbar-expand-md navbar-light ">
                        ...
                        <a class="navbar-brand-sticky" href=" {{route('accueil')}} ">
                            <img src=" {{asset('assets/img/logo1.png')}} "  alt="Logo OctetLab">
                        </a>
					...
					<li class="nav-item">
                                ...
                                <li class="nav-item" id="mobile-lang">
                                    <a href="#" class="nav-link">
                                        {{ session('locale') }}
                                        <i class='bx bxs-chevron-right'></i>
                                    </a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                                            <a href="{{asset('lang/fr')}}" class="nav-link">
                                                Français
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{asset('lang/en')}}" class="nav-link">
                                                English
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{asset('lang/de')}}" class="nav-link">
                                                Deutsch
                                            </a>
                                        </li>
...
var s1=document.createElement("script"),s0=document.getElementsByTagName("script")[0];
s1.async=true;
s1.src='https://embed.tawk.to/626ae738b0d10b6f3e6fd64a/1g1oped7u';
s1.charset='UTF-8';
s1.setAttribute('crossorigin','*');
s0.parentNode.insertBefore(s1,s0);
})();
